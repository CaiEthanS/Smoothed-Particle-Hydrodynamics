function [] = DamBreak(xMax, yMax, h, N, kappa, mu, rho_0, beta, dt, m)
...
% beta. The particles are contained in a grid of size xMax by yMax.

% Create video object
% vid = VideoWriter('DamBreakCase', 'MPEG-4');
% vid.FrameRate = 30;
% vid.Quality = 100;
% open(vid);
